...
class CustomMediaAction {
  ...
  @override
  bool operator ==(Object other) =>
      other.runtimeType == runtimeType && other is CustomMediaAction && name == other.name && mapEquals<String, dynamic>(extras, other.extras);
}
...
class MediaControl {
  ...
  @override
  bool operator ==(Object other) =>
      other.runtimeType == runtimeType && other is MediaControl && androidIcon == other.androidIcon && label == other.label && action == other.action;
}
...
class AudioService {
  ...
  static Future<void> _observeMediaItem() async {
    ...
    _handler.mediaItem.listen((mediaItem) async {
      ...
      if (artUri == null || artUri.scheme == 'content') {
        _platform.setMediaItem(SetMediaItemRequest(mediaItem: mediaItem._toMessage())).catchError(_asyncError.add);
      } else {
  ...
  static final Stream<Duration> position =
  ...
  @Deprecated("Use position instead.")
  static final ValueStream<Duration> positionStream = BehaviorSubject.seeded(Duration.zero, sync: true)
    ..addStream(position)
    ..stream;
}
...
class _HandlerCallbacks extends AudioHandlerCallbacks {
  ...
  @override
  Future<dynamic> customAction(CustomActionRequest request) async => (await handlerFuture).customAction(request.name, request.extras);
  ...
  @override
  Future<void> playFromMediaId(PlayFromMediaIdRequest request) async => (await handlerFuture).playFromMediaId(request.mediaId, request.extras);
  ...
  @override
  Future<void> playFromUri(PlayFromUriRequest request) async => (await handlerFuture).playFromUri(request.uri, request.extras);
  ...
  @override
  Future<void> prepareFromMediaId(PrepareFromMediaIdRequest request) async => (await handlerFuture).prepareFromMediaId(request.mediaId, request.extras);

  @override
  Future<void> prepareFromSearch(PrepareFromSearchRequest request) async => (await handlerFuture).prepareFromSearch(request.query, request.extras);

  @override
  Future<void> prepareFromUri(PrepareFromUriRequest request) async => (await handlerFuture).prepareFromUri(request.uri, request.extras);
